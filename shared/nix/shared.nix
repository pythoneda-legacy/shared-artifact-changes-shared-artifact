rec {
  shellHook-for =
    { package, pythoneda-shared-pythoneda-domain, python, nixpkgsRelease }: ''
      ...
      echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-shared-artifact-changes/shared/tree/$PVERSION\033[0m";
      ...
      echo -e " \033[32m|_|\033[37mA\033[31mS\033[36mD\033[32m |___/   \033[33mSHARED KERNEL FOR ARTIFACT CHANGES   \033[37mhttps://patreon.com/rydnr\033[0m";
      echo;
